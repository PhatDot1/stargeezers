...
def main():
    try:
            ...
            try:
                ...
                if email:
                    ...
                    if email_count % 100 == 0:
                        ...
                        input_df.to_csv(input_csv_path, index=False)
                        git_commit_and_push([input_csv_path, output_csv_path], f"Updated input3.csv and output3.csv with data for {username}")
        ...
        input_df.to_csv(input_csv_path, index=False)
        git_commit_and_push([input_csv_path, output_csv_path], "Final update to input3.csv and output3.csv after processing completion")
